...
public interface LinqWorkflowExecutionService {
        ...
        /**
         * Initialize a workflow execution record with agent context (IN_PROGRESS)
         ...
         * @return The initialized execution record
         */
        Mono<LinqWorkflowExecution> initializeExecutionWithAgentContext(LinqRequest request,
         ...
         * @return The tracked execution
         */
        Mono<LinqWorkflowExecution> trackExecutionWithAgentContext(LinqRequest request, LinqResponse response,
                        Map<String, Object> agentContext);
        ...
        /**
         * Get executions for a specific team with a limit and optional agent task
         * filter
         * 
