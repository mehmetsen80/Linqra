...
public class LinqLlmModelController {
                                ...
                                .flatMap(user -> {
                                        ...
                                        if (user.getRoles().contains("SUPER_ADMIN")) {
                                                return linqLlmModelService.findByTeamId(teamId)
                                                                .collectList()
                                                                .map(configs -> (ResponseEntity<?>) ResponseEntity
                                                                                .ok(configs));
                                        }
                                ...
                                .onErrorResume(error -> {
                                        ...
                                        return Mono.just((ResponseEntity<?>) ResponseEntity
                                                        ...
                                                        .body(ErrorResponse.fromErrorCode(
                                                                        ...
                                                                        "Error getting LLM model configurations: "
                                                                                        + error.getMessage(),
                                ...
                                .flatMap(user -> {
                                        ...
                                        if (user.getRoles().contains("SUPER_ADMIN")) {
                                                return linqLlmModelService
                                                                .findByModelCategoryAndTeamId(modelCategory, teamId)
                                                                .collectList()
                                                                .map(configs -> (ResponseEntity<?>) ResponseEntity
                                                                                .ok(configs));
                                        }
        ...
        public Mono<ResponseEntity<?>> getLlmModelsByModelCategories(
                        ...
                        ServerWebExchange exchange) {
                log.info("Getting LLM model configurations for team: {} and modelCategoryList: {}", teamId,
                                modelCategoryList);
                ...
                return userContextService.getCurrentUsername(exchange)
                                ...
                                .flatMap(user -> {
                                        ...
                                        if (user.getRoles().contains("SUPER_ADMIN")) {
                                                return linqLlmModelService
                                                                .findByModelCategoriesAndTeamId(modelCategoryList,
                                                                                teamId)
                                                                .collectList()
                                                                .map(configs -> (ResponseEntity<?>) ResponseEntity
                                                                                .ok(configs));
                                        ...
                                        return teamService.hasRole(teamId, user.getId(), "ADMIN")
                                                        .flatMap(isAdmin -> {
                                                                ...
                                                                return linqLlmModelService
                                                                                .findByModelCategoriesAndTeamId(
                                                                                                modelCategoryList,
                                                                                                teamId)
                                                                                .collectList()
                                                                                .map(configs -> (ResponseEntity<?>) ResponseEntity
                ...
                return linqLlmModelService.findById(id)
                                .flatMap(model -> userContextService.getCurrentUsername(exchange)
                                                ...
                                                .flatMap(user -> {
                                                        ...
                                                        // For non-SUPER_ADMIN users, check team admin role
                                                        return teamService
                                                                        .hasRole(model.getTeamId(), user.getId(),
                                                                                        "ADMIN")
                                                                        .flatMap(isAdmin -> {
                                                                                if (!isAdmin) {
                                                                                        return Mono.just(
                ...
                return userContextService.getCurrentUsername(exchange)
                                ...
                                .onErrorResume(error -> {
                                        ...
                                        return Mono.just((ResponseEntity<?>) ResponseEntity
                                                        ...
                                                        .body(ErrorResponse.fromErrorCode(
                                                                        ErrorCode.INTERNAL_ERROR,
                                                                        "Error updating LLM model priorities: "
                                                                                        + error.getMessage(),
                                                                        HttpStatus.INTERNAL_SERVER_ERROR.value())));
                                });
        }
