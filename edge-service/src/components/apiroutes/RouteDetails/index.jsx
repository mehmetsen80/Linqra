      ...
      <div className="page-header">
        <div className="header-section">
          ...
          <div className="version-section">
            ...
            >
              {showVersionControl ? 'Hide Version History' : 'Show Version History'} (v{route?.version || 1})
            </button>
            
            {showVersionControl && (
              <VersionControl
                routeIdentifier={route.routeIdentifier}
                currentVersion={route?.version || 1}
            ...
            <div className="health-check-content">
              <div className="health-check-status-section">
                ...
                <div className="health-check-status">
                  ...
                  {renderFieldValue('healthCheck.path', route.healthCheck.path, value => (
