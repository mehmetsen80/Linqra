...
public class VaultHealthController {
    ...
    @GetMapping
    @Operation(summary = "Check vault health", 
               description = "Checks if the vault can be decrypted correctly. Returns health status indicating if vault decryption is working.")
