...
@CompoundIndex(name = "target_modeltype_team_idx", def = "{'target': 1, 'modelType': 1, 'teamId': 1}", unique = true)
@Data
@NoArgsConstructor
@AllArgsConstructor
public class LinqLlmModel {
    @Id
    private String id;
    private String target;            // e.g., "openai", "gemini-embed"
    private String modelType;         // e.g., "gpt-4o", "text-embedding-004", "gemini-embedding-001"
