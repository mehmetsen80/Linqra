...
public class S3ServiceImpl implements S3Service {
        ...
        return Mono.fromCallable(() -> {
            try {
                ...
                if (encryptionKeyVersion != null && !encryptionKeyVersion.isEmpty()) {
                    ...
                    log.debug("Storing encryption key version {} in S3 metadata for key: {}", encryptionKeyVersion,
                            s3Key);
                }
    ...
    public Mono<Void> downloadFile(String s3Key) {
        // Placeholder implementation - use generatePresignedDownloadUrl for actual
        // downloads
