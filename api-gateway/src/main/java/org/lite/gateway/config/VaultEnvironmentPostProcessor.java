        ...
        try {
            ...
            if (vaultMasterKey == null || vaultMasterKey.isEmpty()) {
                ...
                if (vaultMasterKey != null && !vaultMasterKey.isEmpty()) {
                    ...
                    System.setProperty("vault.master.key", vaultMasterKey); // Ensure it resolves for
                                                                            // @Value("${vault.master.key}")
                    System.err.println("Set VAULT_MASTER_KEY and vault.master.key as system properties from .env file");
                }
            }
