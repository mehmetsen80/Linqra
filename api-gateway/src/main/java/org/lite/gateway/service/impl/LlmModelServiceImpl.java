...
public class LlmModelServiceImpl implements LlmModelService {
    ...
    public Mono<LlmModel> createModel(LlmModel model) {
        ...
        return llmModelRepository.save(model)
                .flatMap(saved -> llmCostService.refreshPricingCache()
                        .doOnSuccess(v -> log.info("✅ Refreshed pricing cache after creating model: {}",
                                saved.getModelName()))
                        .thenReturn(saved));
    }
    ...
    public Mono<LlmModel> updateModel(String id, LlmModel model) {
        return llmModelRepository.findById(id)
                ...
                .flatMap(saved -> llmCostService.refreshPricingCache()
                        .doOnSuccess(v -> log.info("✅ Refreshed pricing cache after updating model: {}",
                                saved.getModelName()))
                        .thenReturn(saved));
    }
    ...
    public Mono<Void> deleteModel(String id) {
        return llmModelRepository.findById(id)
                .flatMap(model -> llmModelRepository.deleteById(id)
                        ...
                        .doOnSuccess(v -> log.info("✅ Refreshed pricing cache after deleting model: {}",
                                model.getModelName())));
    }
    ...
    private Mono<Void> initializeDefaultModelsInternal() {
        ...
        return Flux.fromIterable(getDefaultModels())
                .concatMap(defaultModel -> llmModelRepository.findByModelName(defaultModel.getModelName())
    ...
    private List<LlmModel> getDefaultModels() {
        ...
        models.add(createModel("gemini-2.0-flash", "Gemini 2.0 Flash", "gemini", "chat",
                ...
                "https://generativelanguage.googleapis.com/v1beta/models/gemini-2.0-flash:generateContent", null,
                1_000_000, now));
        models.add(createModel("gemini-1.5-pro", "Gemini 1.5 Pro", "gemini", "chat",
                ...
                "https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-pro:generateContent", null,
                2_000_000, now));
        models.add(createModel("gemini-1.5-flash", "Gemini 1.5 Flash", "gemini", "chat",
                ...
                "https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash:generateContent", null,
                1_000_000, now));
        ...
        models.add(createModel("text-embedding-004", "Gemini Text Embedding 004 (Legacy)", "gemini", "embedding",
                ...
                "https://generativelanguage.googleapis.com/v1beta/models/text-embedding-004:embedContent", 768, 3_072,
                now));
        ...
        models.add(createModel("gemini-embedding-001", "Gemini Embedding 001 (Current)", "gemini", "embedding",
                ...
                "https://generativelanguage.googleapis.com/v1beta/models/gemini-embedding-001:embedContent", 768, 3_072,
                now));
