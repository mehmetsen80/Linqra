...
public class KnowledgeHubCollectionServiceImpl implements KnowledgeHubCollectionService {
        ...
        @Override
        public Mono<KnowledgeHubCollection> createCollection(String name, String description,
                        List<KnowledgeCategory> categories, String teamId, String createdBy) {
                                ...
                                .flatMap(exists -> {
                                        ...
                                        return collectionRepository.findByTeamIdAndName(teamId, name)
                                                        ...
                                                        .flatMap(hasDuplicate -> {
                                                                ...
                                                                KnowledgeHubCollection collection = KnowledgeHubCollection
                                                                                .builder()
                                                                                .name(name)
                                                                ...
                                                                return collectionRepository.save(collection)
                                                                                .flatMap(savedCollection -> {
                                                                                        log.info("Created knowledge collection: {} with ID: {}",
                                                                                        ...
                                                                                        auditContext.put(
                                                                                                        "collectionName",
                                                                                                        savedCollection.getName());
                                                                                        auditContext.put("description",
                                                                                                        savedCollection.getDescription());
                                                                                        auditContext.put("categories",
                                                                                                        savedCollection.getCategories() != null
                                                                                                                        ? savedCollection
                                                                                                                                        .getCategories()
                                                                                                                                        .stream()
                                                                                                                                        .map(Enum::name)
                                                                                                                        ...
                                                                                                                        : java.util.Collections
                                                                                                                                        .emptyList());
                                                                                        auditContext.put("createdBy",
                                                                                                        savedCollection.getCreatedBy());
                                                                                        auditContext.put("createdAt",
                                                                                                        savedCollection.getCreatedAt()
                                                                                                                        .toString());

                                                                                        String auditReason = String
                                                                                                        .format(
                                                                                                                        "Knowledge Hub collection '%s' created in team %s",
                                                                                                                        savedCollection.getName(),
                                                                                                                        teamId);

                                                                                        // Log detailed audit event with
                                                                                        // collectionId populated
                                                                                        return auditLogHelper
                                                                                                        .logDetailedEvent(
                                                                                                                        AuditEventType.COLLECTION_CREATED,
                                                                                                                        AuditActionType.CREATE,
                                                                                                                        AuditResourceType.COLLECTION,
                                                                                                                        savedCollection.getId(), // resourceId
                                                                                                                                                 // -
                                                                                                                                                 // the
                                                                                                                                                 // collection
                                                                                                                                                 // ID
        ...
        @Override
        public Mono<KnowledgeHubCollection> updateCollection(String id, String name, String description,
                ...
                return collectionRepository.findById(id)
                                ...
                                .flatMap(collection -> {
                                        ...
                                        if (!collection.getTeamId().equals(teamId)) {
                                                return Mono.error(new RuntimeException(
                                                                "Collection not found or access denied: " + id));
                                        }
                                        ...
                                        return collectionRepository.findByTeamIdAndName(teamId, name)
                                                        ...
                                                        .flatMap(hasDuplicate -> {
                                                                ...
                                                                List<KnowledgeCategory> oldCategories = collection
                                                                                .getCategories();
                                                                ...
                                                                return collectionRepository.save(collection)
                                                                                .flatMap(savedCollection -> {
                                                                                        log.info("Updated knowledge collection: {} with ID: {}",
                                                                                                        savedCollection.getName(),
                                                                                                        savedCollection.getId());
                                                                                        ...
                                                                                        auditContext.put(
                                                                                                        "collectionName",
                                                                                                        savedCollection.getName());
                                                                                        auditContext.put("oldName",
                                                                                                        oldName);
                                                                                        auditContext.put("newName",
                                                                                                        name);
                                                                                        auditContext.put(
                                                                                                        "oldDescription",
                                                                                                        oldDescription);
                                                                                        ...
                                                                                        auditContext.put(
                                                                                                        ...
                                                                                                        categories != null
                                                                                                                        ...
                                                                                                                        : java.util.Collections
                                                                                                                                        .emptyList());
                                                                                        auditContext.put("updatedBy",
                                                                                                        updatedBy);
                                                                                        auditContext.put("updatedAt",
                                                                                                        savedCollection.getUpdatedAt()
                                                                                                                        .toString());

                                                                                        String auditReason = String
                                                                                                        .format(
                                                                                                                        "Knowledge Hub collection '%s' (ID: %s) updated",
                                                                                                                        savedCollection.getName(),
                                                                                                                        savedCollection.getId());
                                ...
                                .flatMap(collection -> {
                                        ...
                                        return documentRepository.findByCollectionId(id)
                                                        ...
                                                        .flatMap(documentCount -> {
                                                                if (documentCount > 0) {
                                                                        return Mono.error(new RuntimeException(
                                                                                        "Cannot delete collection: Collection contains "
                                                                                                        + documentCount
                                                                                                        + " document(s). Please delete or move all documents before deleting the collection."));
                                                                }

                                                                // No documents, safe to delete
                                                                return collectionRepository.deleteById(id)
                                                                                .flatMap(v -> {
                                                                                        log.info("Deleted knowledge collection: {}",
                                                                                                        id);
                                                                                        ...
                                                                                        String auditReason = String
                                                                                                        .format(
                                                                                                                        "Knowledge Hub collection '%s' (ID: %s) deleted",
                                                                                                                        collectionName,
                                                                                                                        id);

                                                                                        // Log detailed audit event as
                                                                                        // part of reactive chain
                                                                                        return auditLogHelper
                                                                                                        .logDetailedEvent(
                                                                                                        ...
                                                                                                        .doOnError(auditError -> log
                                                                                                                        .error(
                                                                                                                                        "Failed to log audit event (collection deletion): {}",
                                                                                                                                        auditError.getMessage(),
                                                                                                                                        auditError))
                                                                                                        .onErrorResume(auditError -> Mono
                                                                                                                        .empty()); // Don't
                                                                                                                                   // fail
                                                                                                                                   // if
                                                                                                                                   // audit
        ...
        public Mono<KnowledgeHubCollection> getCollectionById(String id, String teamId) {
                ...
                return collectionRepository.findByIdAndTeamId(id, teamId)
                                .switchIfEmpty(Mono.error(
                                                new RuntimeException("Collection not found or access denied: " + id)));
        }
        ...
        @Override
        public Mono<KnowledgeHubCollection> assignMilvusCollection(String id, String teamId, String updatedBy,
                        AssignMilvusCollectionRequest request) {
                log.info("Assigning Milvus collection {} to KnowledgeHub collection {} for team {}",
                                request.getMilvusCollectionName(), id, teamId);
                                        ...
                                        return requireMilvusCollectionForTeam(request.getMilvusCollectionName(), teamId)
                                                        .flatMap(collectionInfo -> {
                                                                ...
                                                                if (collectionType != null && !collectionType
                                                                        ...
                                                                        return Mono.error(new RuntimeException(
                                                                                        "Milvus collection '" + request
                                                                                                        .getMilvusCollectionName()
                                                                                                        + "' is not registered as a Knowledge Hub collection."));
                                                                }

                                                                if (milvusDimension != null
                                                                                && requestedDimension != null
                                                                                && !Objects.equals(milvusDimension,
                                                                                                requestedDimension)) {
                                                                        return Mono.error(new RuntimeException(
                                                                                        "Milvus collection '" + request
                                                                                                        .getMilvusCollectionName()
                                                                                                        ...
                                                                                                        + milvusDimension
                                                                                                        +
                                                                                                        " but embedding model requires "
                                                                                                        + requestedDimension));
                                                                }

                                                                Integer effectiveDimension = milvusDimension != null
                                                                                ? milvusDimension
                                                                                : requestedDimension;
                                                                if (effectiveDimension == null) {
                                                                        return Mono.error(new RuntimeException(
                                                                                        "Unable to determine embedding dimension for Milvus collection '"
                                        ...
                                        return collectionRepository.save(collection)
                                                        .flatMap(savedCollection -> {
                                                                log.info("Assigned Milvus collection {} to KnowledgeHub collection {}",
                                                                                savedCollection.getMilvusCollectionName(),
                                                                                savedCollection.getId());

                                                                // Synchronize metadata to Milvus collection properties
                                                                Map<String, String> milvusMetadata = new HashMap<>();
                                                                milvusMetadata.put("embeddingModel",
                                                                                request.getEmbeddingModel());
                                                                milvusMetadata.put("embeddingModelName",
                                                                                request.getEmbeddingModelName());
                                                                milvusMetadata.put("embeddingDimension",
                                                                                String.valueOf(effectiveDimension));
                                                                ...
                                                                return milvusStoreService.updateCollectionMetadata(
                                                                                ...
                                                                                .then(Mono.defer(() -> {
                                                                                        ...
                                                                                        auditContext.put(
                                                                                                        ...
                                                                                                        savedCollection.getName());
                                                                                        auditContext.put(
                                                                                                        "oldMilvusCollectionName",
                                                                                                        oldMilvusCollectionName);
                                                                                        auditContext.put(
                                                                                                        "newMilvusCollectionName",
                                                                                                        request.getMilvusCollectionName());
                                                                                        auditContext.put(
                                                                                                        "oldEmbeddingModel",
                                                                                                        oldEmbeddingModel);
                                                                                        auditContext.put(
                                                                                                        ...
                                                                                                        request.getEmbeddingModel());
                                                                                        auditContext.put(
                                                                                                        "oldEmbeddingModelName",
                                                                                                        oldEmbeddingModelName);
                                                                                        auditContext.put(
                                                                                                        "newEmbeddingModelName",
                                                                                                        request.getEmbeddingModelName());
                                                                                        auditContext.put(
                                                                                                        "oldEmbeddingDimension",
                                                                                                        oldEmbeddingDimension);
                                                                                        auditContext.put(
                                                                                                        "newEmbeddingDimension",
                                                                                                        effectiveDimension);
                                                                                        auditContext.put(
                                                                                                        "oldLateChunkingEnabled",
                                                                                                        oldLateChunkingEnabled);
                                                                                        auditContext.put(
                                                                                                        "newLateChunkingEnabled",
                                                                                                        request.isLateChunkingEnabled());
                                                                                        auditContext.put("updatedBy",
                                                                                                        updatedBy);
                                                                                        auditContext.put("updatedAt",
                                                                                                        savedCollection.getUpdatedAt()
        ...
        public Mono<KnowledgeHubCollection> removeMilvusCollection(String id, String teamId, String updatedBy) {
                ...
                return collectionRepository.findById(id)
                                ...
                                .flatMap(collection -> {
                                        ...
                                        return collectionRepository.save(collection)
                                                        .flatMap(savedCollection -> {
                                                                log.info("Removed Milvus assignment from collection {}",
                                                                                savedCollection.getId());

                                                                // Build detailed audit context
                                                                Map<String, Object> auditContext = new HashMap<>();
                                                                auditContext.put("collectionName",
                                                                                savedCollection.getName());
                                                                auditContext.put("removedMilvusCollectionName",
                                                                                oldMilvusCollectionName);
                                                                auditContext.put("removedEmbeddingModel",
                                                                                oldEmbeddingModel);
                                                                auditContext.put("removedEmbeddingModelName",
                                                                                oldEmbeddingModelName);
                                                                auditContext.put("removedEmbeddingDimension",
                                                                                oldEmbeddingDimension);
                                                                auditContext.put("removedLateChunkingEnabled",
                                                                                oldLateChunkingEnabled);
                                                                auditContext.put("updatedBy", updatedBy);
                                                                auditContext.put("updatedAt", savedCollection
                                                                                .getUpdatedAt().toString());

                                                                String auditReason = String.format(
                                                                                "Milvus collection assignment removed from Knowledge Hub collection '%s'",
                                                                                savedCollection.getName());
        ...
        @Override
        public Mono<Map<String, Object>> searchCollection(String collectionId, String teamId, String query,
                        Integer topK,
                ...
                return collectionRepository.findById(collectionId)
                                .switchIfEmpty(Mono
                                                .error(new RuntimeException("Collection not found: " + collectionId)))
                                .flatMap(collection -> {
                                        ...
                                        if (!StringUtils.hasText(collection.getMilvusCollectionName())) {
                                                return Mono.error(new IllegalStateException(
                                                                "Collection is not linked to a Milvus collection. Assign embeddings before searching."));
                                        }

                                        if (!StringUtils.hasText(collection.getEmbeddingModel())
                                                        || !StringUtils.hasText(collection.getEmbeddingModelName())) {
                                                return Mono.error(new IllegalStateException(
                                                                "Embedding configuration is incomplete for this collection."));
                                        }
                                        ...
                                        return milvusStoreService.searchRecord(
                                                        ...
                                                        .flatMap(searchResults -> {
                                                                ...
                                                                auditContext.put("collectionName",
                                                                                collection.getName());
                                                                auditContext.put("milvusCollectionName",
                                                                                collection.getMilvusCollectionName());
                                                                auditContext.put("embeddingModel",
                                                                                collection.getEmbeddingModel());
                                                                auditContext.put("embeddingModelName",
                                                                                collection.getEmbeddingModelName());
                                                                auditContext.put("query", query);
                                                                auditContext.put("topK", effectiveTopK);
                                                                auditContext.put("metadataFilters",
                                                                                metadataFilters != null
                                                                                                ? metadataFilters
                                                                                                : java.util.Collections
                                                                                                                .emptyMap());
                                                                auditContext.put("resultCount",
                                                                                searchResults != null
                                                                                                && searchResults instanceof Map
                                                                                                                ? ((Map<?, ?>) searchResults)
                                                                                                                                .size()
                                                                                                                : 0);
                                                                auditContext.put("searchTimestamp",
                                                                                LocalDateTime.now().toString());
                                                                auditContext.put("executedBy", executedBy);

                                                                String auditReason = String.format(
                                                                                "Semantic search executed on collection '%s' with query: '%s' (topK: %d)",
                                                                                collection.getName(), query,
                                                                                effectiveTopK);

                                                                // Log detailed audit event
                                                                return auditLogHelper.logDetailedEvent(
                                                                                AuditEventType.CHUNK_ACCESSED, // Using
                                                                                                               // CHUNK_ACCESSED
                                                                                                               // for
                                                                                                               // search
                                                                                                               // operations
                                                        ...
                                                        .onErrorResume(error -> {
                                                                log.error("Semantic search failed for collection {}: {}",
                                                                                collectionId,
                                                                                error.getMessage(), error);

                                                                // Log failed search attempt
                                                                Map<String, Object> errorContext = new HashMap<>();
                                                                errorContext.put("collectionName",
                                                                                collection.getName());
                                                                errorContext.put("query", query);
                                                                errorContext.put("error", error.getMessage());
                                                                errorContext.put("searchTimestamp",
                                                                                LocalDateTime.now().toString());
                                                                ...
                                                                return auditLogHelper.logDetailedEvent(
                                                                                ...
                                                                                AuditResourceType.COLLECTION,
                                                                                collectionId,
                                                                                String.format("Semantic search failed on collection '%s'",
                                                                                                collection.getName()),
                                                                                errorContext,
                                                                                null,
                                                                                collectionId)
                                                                                .doOnError(
                                                                                                auditError -> log.error(
                                                                                                                "Failed to log audit event (search failed): {}",
                                                                                                                auditError.getMessage(),
                                                                                                                auditError))
                                                                                .onErrorResume(auditError -> Mono
                                                                                                .empty()) // Don't fail
                                                                                                          ...
                                                                                                          // logging
                                                                                                          // fails
                                                                                .then(Mono.error(error)); // Return the
                                                                                                          // original
                                                                                                          // error after
                                                                                                          // logging
                                                        });
