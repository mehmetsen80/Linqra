                ...
                return Mono.just(request.getUsername())
                                ...
                                .switchIfEmpty(Mono.defer(() -> {
                                        ...
                                        AuditLog.AuditMetadata userNotFoundMetadata = AuditLog.AuditMetadata.builder()
                                                        .reason(String.format("Login failed - user not found: %s",
                                                                        request.getUsername()))
                                        ...
                                        return auditService.logEvent(
                                                        ...
                                                        .doOnError(auditError -> log.error(
                                                                        "Failed to log failed login audit event: {}",
                                ...
                                .flatMap(user -> {
                                        if (passwordEncoder.matches(request.getPassword(), user.getPassword())) {
                                                ...
                                                AuditLog.AuditMetadata loginMetadata = AuditLog.AuditMetadata.builder()
                                                                .reason(String.format(
                                                                                "User login successful for username: %s",
                                                                                user.getUsername()))
                                                                .build();
                                                ...
                                                return auditService.logEvent(
                                                                ...
                                                                .doOnError(auditError -> log.error(
                                                                                "Failed to log login audit event: {}",
                                                                                auditError.getMessage(), auditError))
                                        ...
                                        AuditLog.AuditMetadata failedLoginMetadata = AuditLog.AuditMetadata.builder()
                                                        .reason(String.format("Invalid password for user: %s",
                                                                        user.getUsername()))
                ...
                Mono<AuthResponse> registrationMono = userRepository.existsByUsername(request.getUsername())
                                .flatMap(exists -> {
                                        if (exists) {
                                                ...
                                                AuditLog.AuditMetadata duplicateUsernameMetadata = AuditLog.AuditMetadata
                                                                .builder()
                                                                .reason(String.format(
                                                                                "Registration failed - duplicate username: %s",
                                                                                request.getUsername()))
                                                ...
                                                return auditService.logEvent(
                                                                ...
                                                                request.getUsername(), // resourceId - attempted
                                                                                       // username
                                                                null, // documentId
                                                                null, // collectionId
                                                                "FAILED",
                                                                ...
                                                                .doOnError(auditError -> log.error(
                                                                                "Failed to log failed registration audit event: {}",
                                                                                auditError.getMessage(), auditError))
                                                                .onErrorResume(auditError -> Mono.empty()) // Don't fail
                                                                                                           // if audit
                                                                                                           // logging
                                ...
                                .flatMap(emailExists -> {
                                        if (emailExists) {
                                                ...
                                                AuditLog.AuditMetadata duplicateEmailMetadata = AuditLog.AuditMetadata
                                                                .builder()
                                                                .reason(String.format(
                                                                                "Registration failed - duplicate email for username: %s",
                                                                                request.getUsername()))
                                        ...
                                        return userRepository.save(newUser)
                                                        .flatMap(savedUser -> {
                                                                String token = jwtService
                                                                                .generateToken(savedUser.getUsername());
                                                                ...
                                                                // Log audit event for successful registration as part
                                                                // of the reactive chain
                                                                AuditLog.AuditMetadata registrationMetadata = AuditLog.AuditMetadata
                                                                                .builder()
                                                                                .reason(String.format(
                                                                                                "User registration successful for username: %s",
                                                                                                savedUser.getUsername()))
                                                                                .build();
                                                                ...
                                                                return auditService.logEvent(
                                                                                ...
                                                                                AuditActionType.CREATE.name(),
                                                                                AuditResourceType.USER.name(),
                                                                                savedUser.getId(), // resourceId - user
                                                                                                   // ID
                                                                                null, // documentId
                                                                                null, // collectionId
                                                                                "SUCCESS",
                                                                                ...
                                                                                .doOnError(auditError -> log.error(
                                                                                                "Failed to log registration audit event: {}",
                                                                                ...
                                                                                .then(notificationService
                                                                                                .sendWelcomeEmail(
                                                                                                                ...
                                                                                                                savedUser.getUsername())
                                                                                                .doOnError(e -> log
                                                                                                                .error("Failed to send welcome email to user {}: {}",
                                                                                                                                savedUser.getUsername(),
                                                                                                                                e.getMessage()))
        ...
        public Mono<User> findByUsernameForLogin(String username) {
                ...
                return userRepository.findByUsername(username)
                                ...
                                .switchIfEmpty(Mono.error(new ResourceNotFoundException(
                                                ...
                                                ErrorCode.USER_NOT_FOUND)))
                                .doOnError(error -> log.error("Error finding user by username: {}",
                                                error.getMessage()));
        }
