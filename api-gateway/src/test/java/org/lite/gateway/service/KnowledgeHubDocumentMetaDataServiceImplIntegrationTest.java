...
class KnowledgeHubDocumentMetaDataServiceImplIntegrationTest {
        ...
        void testExtractMetadata_CreateTestDocument() {
                ...
                String processedS3Key = storageProperties.buildProcessedKey(TEST_TEAM_ID, TEST_COLLECTION_ID,
                                testDocumentId);
                ...
                try {
                        ...
                        String jsonContent = objectMapper.writerWithDefaultPrettyPrinter()
                                        .writeValueAsString(processedJson);
                        ...
                        KnowledgeHubDocument document = KnowledgeHubDocument.builder()
                                        ...
                                        .s3Key("raw/" + TEST_TEAM_ID + "/" + TEST_COLLECTION_ID + "/" + testDocumentId
                                                        + "_test.pdf")
                        ...
                        StepVerifier.create(metadataService.extractMetadata(testDocumentId, TEST_TEAM_ID))
                                        .assertNext(metadata -> {
                                                ...
                                                assertEquals("sentence",
                                                                metadata.getCustomMetadata().get("chunkStrategy"));
