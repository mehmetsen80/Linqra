...
class S3ServiceImplIntegrationTest {
    ...
    void testFileExists_RealIntegration() {
        ...
        //String existingKey = "raw/test-team/test-collection/VERIFY_UPLOAD_1761864802696.txt";
        //String nonExistentKey = "raw/test-team/test-collection/NON_EXISTENT_FILE_" + System.currentTimeMillis() + ".txt";
